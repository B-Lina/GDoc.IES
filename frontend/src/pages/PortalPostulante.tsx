...
const documentosIniciales: DocumentoRequisito[] = [
    { id: 1, requisito_nombre: "Cédula de Ciudadanía", descripcion: "Cargue copia legible por ambas caras", es_obligatorio: true, estado_actual: "PENDIENTE", archivo_url: null, observaciones: "" },
    { id: 2, requisito_nombre: "Hoja de Vida", descripcion: "Formato institucional diligenciado completamente", es_obligatorio: true, estado_actual: "APROBADO", archivo_url: "/media/documentos/hv_garcia.pdf", observaciones: "" },
    { id: 3, requisito_nombre: "Diploma de Pregrado", descripcion: "Copia autenticada del diploma universitario", es_obligatorio: true, estado_actual: "RECHAZADO", archivo_url: "/media/documentos/diploma_garcia.pdf", observaciones: "Documento ilegible. La resolución es muy baja y no se distingue el nombre de la institución. Por favor suba una copia con mejor calidad." },
    { id: 4, requisito_nombre: "Diploma de Posgrado", descripcion: "Copia autenticada del título de posgrado", es_obligatorio: true, estado_actual: "CARGADO", archivo_url: "/media/documentos/posgrado_garcia.pdf", observaciones: "" },
    { id: 5, requisito_nombre: "Certificado de Antecedentes", descripcion: "Vigente, expedido hace menos de 3 meses", es_obligatorio: true, estado_actual: "PENDIENTE", archivo_url: null, observaciones: "" },
    { id: 6, requisito_nombre: "Certificaciones Laborales", descripcion: "Últimos 5 años de experiencia profesional", es_obligatorio: false, estado_actual: "PENDIENTE", archivo_url: null, observaciones: "" },
];
...
export default function PortalPostulante() {
    ...
    const handleUpload = (docId: number) => {
        ...
        toast({ title: "Archivo recibido", description: "Su documento fue cargado y será revisado por el equipo." });
    };
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-1">
                <h1 className="text-2xl font-bold tracking-tight text-foreground">Bienvenido, Postulante</h1>
                <p className="text-muted-foreground">Complete la documentación requerida para su postulación.</p>
            </div>
            ...
            <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Suba cada documento en formato PDF o JPG. Serán revisados por el equipo evaluador.</p>
            </div>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="space-y-1">
                                        <CardTitle className="text-base flex items-center gap-2">
                                            ...
                                            {doc.es_obligatorio && <span className="text-xs font-normal text-destructive">* Obligatorio</span>}
                                        </CardTitle>
